      ...
      <div className="navy-gradient px-4 py-3 sm:px-6 sm:py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 text-primary-foreground">
            ...
            <div>
              <h3 className="font-semibold text-sm sm:text-base">Ваша подпись</h3>
          ...
          {hasSignature && (
            <div className="flex items-center gap-2">
              <span className="text-xs text-green-400 flex items-center gap-1">
                ...
                <span className="hidden sm:inline">Подпись добавлена</span>
              </span>
              <Button
                variant="ghost"
                size="sm"
                onClick={clearSignature}
                className="text-primary-foreground/80 hover:text-primary-foreground hover:bg-white/10 h-8 px-2 sm:px-3"
              >
        ...
        <div className="relative bg-gradient-to-b from-gray-50 to-white">
          ...
          <div className="px-4 py-6 sm:px-8 sm:py-8">
            <div className="relative bg-white rounded-lg border-2 border-dashed border-muted-foreground/20 hover:border-gold/50 transition-colors">
              ...
              <div className="absolute bottom-2 left-8 text-[10px] text-muted-foreground/50 pointer-events-none">
                подпись
              </div>
          ...
          <div className="px-4 pb-4 sm:px-8 sm:pb-6">
            <p className="text-xs text-muted-foreground text-center bg-muted/50 rounded-md py-2 px-3">
              💡 Подпись будет добавлена в документ. Используйте палец или мышь для рисования.
            </p>
          </div>
        </div>
      </CardContent>
